...
const translations = {
  ...
  en: {
    ...
    summaryLead: "I build data pipelines and LLM system prototypes: source ingestion, SQL storage, processing stages and result validation.",
    ...
    projectsHeading: "Independent engineering projects",
    projectsIntro: "Self-directed development and research prototypes.",
    prototype: "Prototype",
