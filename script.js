const translations = {
  en: {
    ...
    approachTwo: "Keep intermediate state, logs and failure paths visible.",
    approachThree: "Ship editable, reviewable artifacts — not black boxes.",
  ...
  ru: {
    ...
    availability: "Коимбра · Португалия · Remote",
    download: "Скачать",
    ...
    approachTwo: "Делаю видимыми состояние, логи и сценарии отказа.",
    approachThree: "Передаю редактируемые артефакты, а не чёрные ящики.",
...
setLanguage(requestedLanguage || browserLanguage, Boolean(requestedLanguage));
